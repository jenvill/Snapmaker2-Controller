...
// The size of the print bed
// When SW_MACHINE_SIZE is enabled the machine size can change at runtime
// (A150/A250/A350, kit combinations, etc). Use the dynamic definition sizes
// so bed probing/leveling covers the full bed.
#if ENABLED(SW_MACHINE_SIZE)
#undef X_BED_SIZE
#undef Y_BED_SIZE
#define X_BED_SIZE X_DEF_SIZE
#define Y_BED_SIZE Y_DEF_SIZE
#endif
